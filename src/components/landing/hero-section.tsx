...
export function HeroSection() {
  return (
    <section className="mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1fr_1fr] lg:items-center lg:px-8 lg:py-24">
      <Reveal from="left">
        <h1 className="max-w-xl font-display text-5xl leading-[0.95] tracking-[-0.03em] text-balance sm:text-6xl lg:text-7xl">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          ...
          <LandingButton landingVariant="secondary" size="lg" asChild>
